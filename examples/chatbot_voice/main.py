    ...
    async for chunk in brain.ask_streaming(message.content, retrieval_config=retrieval_config):
        ...
        for source in chunk.metadata.sources:
            if source.page_content not in saved_sources:
                ...
                # LINEAJE: enforce() `source` at agent->log log_emit — scan flagged AI_DAT_SEC_010 (Do not log PII.). Mask/block; do not remove without review. site_id='site:sha256:22f161ed56d256f46ba6b12c58f23d6595554b68757ad08ea3edb162e5c592eb'
                _gr_client = _lineaje_load_gr_client()
