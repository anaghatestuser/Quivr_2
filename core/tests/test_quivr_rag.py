...
async def test_quivrqaraglanggraph(
    ...
    # LINEAJE: enforce() `chat_history` at agent->tool post_tool — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:00cbaafc4e8c040b4efeb9dbdd2789de6e2454d9c332d4a31d9a7f23d41a81e6'
    _gr_client = _lineaje_load_gr_client()
    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:00cbaafc4e8c040b4efeb9dbdd2789de6e2454d9c332d4a31d9a7f23d41a81e6', phase='post_tool', boundary={'source': 'tool_result', 'sink': 'agent_message'}, candidate_policies=[], fail_mode='ALLOW_WITH_AUDIT', source_type='agent', destination_type='tool')
