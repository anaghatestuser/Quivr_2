...
async def test_quivrqaraglanggraph(
    ...
    # LINEAJE: enforce() `chat_history` at agent->tool post_tool — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:fa9526c26008a069ffe40635a800ac6f2bc36843e6d06ca73969ca3e11a5c6fe'
    _gr_client = _lineaje_load_gr_client()
    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:fa9526c26008a069ffe40635a800ac6f2bc36843e6d06ca73969ca3e11a5c6fe', phase='post_tool', boundary={'source': 'tool_result', 'sink': 'agent_message'}, candidate_policies=[], fail_mode='ALLOW_WITH_AUDIT', source_type='agent', destination_type='tool')
