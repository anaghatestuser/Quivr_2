...
async def test_quivrqaraglanggraph(
    ...
    # LINEAJE: enforce() `llm_config` at llm->agent post_model — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list); AI_IAC_SEC_020 (Restrict AI agents to an explicit tool allow list.). Mask/block; do not remove without review. site_id='site:sha256:50ae0adeaf2582993b3bcbbeab8b5a23e554229662e76e7272f14629dda1affc'
    _gr_client = _lineaje_load_gr_client()
    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:50ae0adeaf2582993b3bcbbeab8b5a23e554229662e76e7272f14629dda1affc', phase='post_model', boundary={'source': 'model', 'sink': 'agent_message'}, candidate_policies=[], fail_mode='ALLOW_WITH_AUDIT', source_type='llm', destination_type='agent')
    ...
    # LINEAJE: enforce() `llm_config` at agent->policy_engine security_decision — scan flagged AI_IAC_018 (Enforce cryptographically verified user-to-agent binding for every request.). Mask/block; do not remove without review. site_id='site:sha256:781a0ee544ea6881c871a85ddf89d6a6fe3b8f9dcf24267a4a411d7c83d131fa'
    _gr_client = _lineaje_load_gr_client()
    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:781a0ee544ea6881c871a85ddf89d6a6fe3b8f9dcf24267a4a411d7c83d131fa', phase='security_decision', boundary={'source': 'agent_message', 'sink': 'agent_message'}, candidate_policies=[], fail_mode='ALLOW_WITH_AUDIT', source_type='agent', destination_type='policy_engine')
